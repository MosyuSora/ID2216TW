// these are example dishes for testing the UI in TW1. In TW2 you will fetch your own dishes from the API
// the file is also used by dish-related unit tests
...
function getDishDetails(x) {
  return dishesConst.find(function (d) {
    return d.id === x
  })
}
...
dishesConst.ingrList1 = [
  ...
  { name: "dried oregano", aisle: "Spices", amount: 0.5, unit: "g", id: 1120 },
  {
    name: "crushed red pepper flakes",
    aisle: "Spices",
    amount: 0.5,
